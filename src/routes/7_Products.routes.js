...
import { changeStatusById, createProduct, deleteProductById, findProductByDateRange, getProductById, getProducts, getProductsByCategory, getProductsCatalog, updateProductById } from "../controllers/7_Products.controller.js";
...
router.post('/products_daterange', [], findProductByDateRange); // Obtener Productos con su Disponibilidad (req.body)
