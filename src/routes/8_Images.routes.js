...
import { createImage, deleteImageById, getImageById, getImages, getImagesByProduct, updateImageByProduct, uploadImages } from "../controllers/8_Images.controller.js";
...
router.put('/images/:id', [], updateImageByProduct); // Editar (req.params y req.body)
